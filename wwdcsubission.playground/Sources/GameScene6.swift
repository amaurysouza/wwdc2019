...
public class GameScene6: SKScene, SKPhysicsContactDelegate {
    ...
    public override func didMove(to view: SKView) {
        ...
        boaDecisao = childNode(withName: "//boaDecisao3") as? SKSpriteNode
        maDecisao = childNode(withName: "//maDecisao3") as? SKSpriteNode
    ...
    func touchDown(atPoint pos : CGPoint) {
        ...
        if verificador == true{
            ...
            if let scene7 = GameScene7(fileNamed: "GameScene7") {
                removeAllChildren()
                scene7.scaleMode = .aspectFill
                self.view?.presentScene(scene7)
